class SceneManager {
    ...
    loadLevelOne() {
		...
		gameEngine.addEntity(new ThunderArmor(gameEngine, 500, 195, 0, [{ x: randomInt(800), y: randomInt(800) }, { x: randomInt(800), y: randomInt(800) }, { x: randomInt(800), y: randomInt(800) }, { x: 0, y: 0 }]));
