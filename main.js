...
ASSET_MANAGER.downloadAll(() => {
	...
	gameEngine.addEntity(new box(gameEngine,705,1,400,380,128,127));  
	gameEngine.addEntity(new box(gameEngine,705,1,300,450,50,50)); 
	gameEngine.addEntity(new boundingfloor(gameEngine,0,510,1984,10)); 
