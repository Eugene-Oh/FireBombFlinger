...
ASSET_MANAGER.downloadAll(() => {
	...
	gameEngine.addEntityToFrontOfList(new Player(gameEngine, 50, 0));
	gameEngine.addEntityToFrontOfList(new Sniper(gameEngine, 980, 383, 0));
	gameEngine.addEntityToFrontOfList(new Sniper(gameEngine, 375, 0, 1));
	gameEngine.addEntityToFrontOfList(new box(gameEngine,705,1,511,297,128,127));
	//gameEngine.addEntity(new Bullet(gameEngine, 0, 0, 100, 305, 13, 6));
	gameEngine.addEntityToBackOfList(new Background(gameEngine));
